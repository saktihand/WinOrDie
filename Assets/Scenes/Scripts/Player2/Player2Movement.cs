...
public class Player2Movement : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Ambil referensi untuk rigidbody dan animator dari objek
    ...
    private void Update()
    {
        ...
        // Gunakan input kontrol untuk Player 2
        ...
        if (wallJumpCooldown > 0.2f)
        {
            ...
            // Gunakan tombol X joystick untuk melompat
    ...
    public void SetGameOver(bool status)
    {
        ...
        if (isGameOver)
        {
            ...
            body.isKinematic = true; // Nonaktifkan physics
        }
        else
        {
            body.isKinematic = false; // Kembalikan physics ketika game selesai
        }
    }
}
